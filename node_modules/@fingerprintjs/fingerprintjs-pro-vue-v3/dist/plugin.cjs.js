...
const fpjsPlugin = {
    install: (app, options) => {
        const client = new fingerprintjsProSpa.FpjsClient(getOptions(options, 'fingerprintjs-pro-vue-v3', version));
...
function useVisitorData(_a = {}, _b) {
    ...
    const currentError = vue.ref();
    const getVisitorData = vue.inject(GET_VISITOR_DATA);
    if (!getVisitorData) {
...
exports.GET_VISITOR_DATA = GET_VISITOR_DATA;
exports["default"] = fpjsPlugin;
exports.fpjsGetVisitorDataExtendedMixin = fpjsGetVisitorDataExtendedMixin;
exports.fpjsGetVisitorDataMixin = fpjsGetVisitorDataMixin;
exports.fpjsPlugin = fpjsPlugin;
