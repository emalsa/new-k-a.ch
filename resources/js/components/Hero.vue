      ...
      <div class="flex flex-wrap -mx-4 items-center mb-16">
        <div class="w-full lg:w-1/2 px-4 mb-24 lg:mb-0">
          <div class="max-w-md md:max-w-lg mx-auto xl:mx-0">
            ...
            <p class="text-lg leading-8 mb-10">Der Austritt aus der Kirche erstellt du in wenigen Minuten online. Wir finden die zuständige Kirchgemeinde und machen den Rest.</p>
