          ...
          <div class="mb-6 mx-auto max-w-xl">
            ...
            <div class="mb-8">
              ...
              <span v-if="isStep2" class="text-sm font-semibold uppercase">
                <span>Dein</span>
                <span class="text-green-500">&nbsp;Ehepartner/In?</span>
              </span>
            ...
            <div class="mb-10 max-w-xs text-2xl mt-2 uppercase">
              ...
              <h4 v-if="isStep2">Ehepartner/in</h4>
              <h4 v-if="isStep3">Kinder</h4>
              <!--              <h4 v-if="isStep4">Kirchgemeinde</h4>-->
              <h4 v-if="isStep4">&Uuml;bersicht</h4>
            </div>
            <div v-if="errors.length" class="bg-red-200 p-4">
              <div>
                <b>Fehler gefunden:</b>
                <ul>
                  <li class="m-2" v-for="error in errors">{{ error }}</li>
                </ul>
              </div>
            </div>
                        ...
                        <div v-if="formData.payment">
                          ...
                          <div class="mb-6 mt-6">
                            ...
                            <div class="max-w-2xl mx-auto">
                              <div class="mr-2 mb-2 px-5 py-2.5 text-gray-900 bg-white border border-gray-200 font-medium rounded-lg text-sm  text-center inline-flex items-center">
                              ...
                              <div class="mr-2 mb-2 px-5 py-2.5 text-gray-900 bg-white border border-gray-200 font-medium rounded-lg text-sm  text-center inline-flex items-center dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                                ...
                                <div class="hidden md:block">MasterCard</div>
                              </div>

                              <div class="text-white bg-[#2557D6] font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                                <svg class="-ml-1 w-7 h-4 mr-2"
                                     viewBox="0 0 256 64"
                                     fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
