          ...
          <div class="w-full lg:w-1/2 px-4 mb-8 lg:mb-0">
            <div class="p-8 bg-white rounded-md">
              <div class="text-center mb-8">
                <span class="font-heading font-medium text-lg">Gratis</span>
                <div class="flex items-start justify-center mt-2">
                  <span class="font-heading font-medium text-3xl leading-10">0</span>
              ...
              <ul>
                ...
                <li class="flex items-center mb-3">
                  ...
                  <span class="ml-4 text-sm">Mit Ehepartner / Kinder (optional)</span>
                </li>
                <li class="flex items-center mb-3">
                  <svg width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5.5 10.5L8.5 13.5L14.5 7"
                  ...
                  <span class="ml-4 text-sm">Versandbereit<span class="ml-0.5">*</span></span>
                </li>
                <li class="flex items-center text-gray-300 mb-3">
                  <svg xmlns="http://www.w3.org/2000/svg"
                       ...
                       viewBox="0 0 24 24"
                       data-tags="x-circle">
                    <g fill="#444" transform="scale(0.0234375 0.0234375)">
            ...
            <div class="relative p-8 bg-white border-2 border-green-500 rounded-md">
              ...
              <ul>
                ...
                <li class="flex items-center mb-3">
                  ...
                  <span class="ml-4 text-sm">Versandbereit</span>
                </li>
                <li class="flex items-center mb-3">
                  <svg width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5.5 10.5L8.5 13.5L14.5 7"
