...
<div class="page">
  <div class="wrapper">
    <div class="sender">
      <p>
        {{$personData['vorname'] ? : 'Vorname'}}&nbsp;{{ $personData['nachname'] ? : 'Nachname'}}</p>
      <p>{{$personData['streetAddress'] ? : 'Strasse'}}</p>
      <p>{{$personData['streetAdditionalAddress']}}</p>
      <p>
        {{$personData['postalAddress'] ? : 'PLZ'}}&nbsp;{{ $personData['locationAddress'] ? : 'Ort'}}</p>
    </div>
    ...
    <div class="text">
      ...
      <div class="text-1">
        <p>
          Nach reiflicher &Uuml;berlegung habe ich mich entschieden, aus der
          öffentlich-rechtlichen Institution der Landeskirche auszutreten.
          Hiermit erkl&auml;re ich meinen vollst&auml;ndigen Austritt sowohl aus
          der Kirchgemeinde als auch aus der {{$confessionFull}} Kirche mit
          sofortiger Wirkung.
        </p>
      </div>
      <div class="person-data">
        <table>
          <tr>
            <td>Vorname:</td>
            <td>{{$personData['vorname'] ? : 'Vorname'}}</td>
          </tr>
          <tr>
            <td>Nachname:</td>
            <td>{{$personData['nachname'] ? : 'Nachname'}}</td>
          </tr>
          <tr>
            <td>Geburtsdatum:</td>
      ...
      <div class="text-2">
        <p>
          Ich w&uuml;nsche keine Kontaktaufnahme von der Kirche und lehne
          jegliche Gespr&auml;che dankend ab. Ich beabsichtige, keine Gr&uuml;nde
          f&uuml;r meinen Austritt zu nennen. Dies ist f&uuml;r einen Austritt
          nicht notwendig.
          Ich bin nur f&uuml;r eine Kontaktaufnahme bereit, falls es Gr&uuml;nde
          gibt, die meinen Austritt unumg&auml;nglich verhindern.
          Ich bitte Sie h&ouml;flich, mich umgehend zu informieren, sollte ein
          solcher Fall eintreten. Ich bin damit einverstanden, dass nicht
          korrekte oder falsch aufgef&uuml;hrte Informationen in meiner
  ...
  <div class="text-3">
    <p>
      Ich bin mir der m&ouml;glichen Folgen und Konsequenzen meines Austritts
      aus der Kirche vollst&auml;ndig bewusst und ich bin informiert &uuml;ber
      die Rechte, auf die ich mit meinem Austritt verzichte. Ich bitte Sie, alle
      notwendigen Schritte einzuleiten und die relevanten Stellen, wie die
      Einwohnerkontrolle und die Kirchgemeinde, zu informieren.
    </p>
  </div>
  <div class="text-4">
    <p>
  ...
  <div class="text-4">
    <p>Freundliche Gr&uuml;sse<br/>
      {{$personData['vorname'] ? : 'Vorname'}}&nbsp;{{ $personData['nachname'] ? : 'Nachname'}}
    </p>
  </div>
